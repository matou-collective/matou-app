<template>
  <div class="dashboard-page">
    ...
    <ProfileModal
      ...
      :canChangeRole="canManageMembers && !!selectedMemberSharedProfile && (selectedMemberSharedProfile.aid as string) !== (identityStore.currentAID?.prefix || '')"
      :canRemoveMember="canManageMembers && !!selectedMemberSharedProfile && (selectedMemberSharedProfile.aid as string) !== (identityStore.currentAID?.prefix || '')"
