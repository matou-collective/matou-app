    ...
    <div class="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <div class="prose prose-lg max-w-none space-y-6">
        ...
        <div>
          ...
          <section class="bg-card border border-border rounded-xl p-6">
            <p class="text-muted-foreground mb-4">
              At {{ brandName }}, we are committed to protecting your privacy and ensuring data sovereignty. This Privacy Policy explains how we collect, use, store, and protect your personal information when you use our platform.
            </p>
        ...
        <div>
          ...
          <section class="bg-card border border-border rounded-xl p-6">
            <p class="text-muted-foreground">
              <strong class="text-foreground">You own your data.</strong> {{ brandName }} is built on principles of data sovereignty, meaning that you maintain ownership and control over your personal information. We provide tools and infrastructure to help you manage your data, but you decide what to share and with whom.
            </p>
          </section>
        </div>
          ...
          <section class="bg-card border border-border rounded-xl p-6">
            <ul class="space-y-3 text-muted-foreground">
              <li class="flex items-start gap-3">
                ...
                <span>To provide and maintain the {{ brandName }} platform and services</span>
              </li>
              <li class="flex items-start gap-3">
                <CheckCircle class="w-5 h-5 text-accent shrink-0 mt-0.5" />
        ...
        <div>
          ...
          <section class="bg-card border border-border rounded-xl p-6">
            <p class="text-muted-foreground">
              {{ brandName }} is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If you believe we have collected information from a child, please contact us immediately.
            </p>
          </section>
        </div>
        ...
        <div>
          ...
          <section class="bg-card border border-border rounded-xl p-6">
            ...
            <p class="text-sm text-muted-foreground">
              For data deletion requests or other privacy-related concerns, please use the appropriate channels in the {{ brandName }} community platform.
            </p>
          </section>
        </div>
      </div>
