...
// yet have its own feature table — i.e. everything except the Chat columns,
// which the Chat table below owns.
const capabilityIds = computed(() =>
  store.capabilityColumns.filter((cap) => !chatCapabilityIds.value.includes(cap)),
);
