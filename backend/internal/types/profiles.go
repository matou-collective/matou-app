...
func PrivateProfileType() *TypeDefinition {
	return &TypeDefinition{
		...
		Space:       "private",
		Fields: []FieldDef{
			{Name: "membershipCredentialSAID", Type: "string", Required: true, ReadOnly: true, Core: true,
...
func SharedProfileType() *TypeDefinition {
	...
	return &TypeDefinition{
		...
		Space:       "community",
		Fields: []FieldDef{
			{Name: "aid", Type: "string", Required: true, ReadOnly: true, Core: true,
				UIHints: &UIHints{Label: "AID", Section: "identity"}},
			{Name: "status", Type: "string", Required: true, Core: true,
				Validation: &Validation{Enum: []string{"pending", "approved", "declined"}},
				UIHints:    &UIHints{DisplayFormat: "badge", Label: "Status", Section: "membership", Filterable: true}},
			{Name: "publicPeerSignkey", Type: "string", ReadOnly: true, Core: true,
				UIHints: &UIHints{Label: "Public Signing Key", Section: "identity"}},
			{Name: "displayName", Type: "string", Required: true, Core: true,
				Validation: &Validation{MinLength: &minDisplayName, MaxLength: &maxDisplayName},
				UIHints:    &UIHints{InputType: "text", Label: "Display Name", Placeholder: "Your display name", Section: "profile", Filterable: true}},
			...
			{Name: "avatar", Type: "string", Core: true,
				UIHints: &UIHints{InputType: "image-upload", DisplayFormat: "avatar", Label: "Profile Photo", Section: "profile"}},
			{Name: "location", Type: "string",
				UIHints: &UIHints{InputType: "text", Label: "Location", Placeholder: "City, Country", Section: "profile", Filterable: true}},
			...
			{Name: "skills", Type: "array",
				UIHints: &UIHints{InputType: "tags", DisplayFormat: "chip-list", Label: "Skills", Section: "interests", Filterable: true}},
			{Name: "languages", Type: "array",
				UIHints: &UIHints{InputType: "tags", DisplayFormat: "chip-list", Label: "Languages", Section: "interests", Filterable: true}},
			...
			{Name: "lastActiveAt", Type: "datetime", ReadOnly: true, Core: true,
				UIHints: &UIHints{DisplayFormat: "relative-date", Label: "Last Active"}},
			{Name: "createdAt", Type: "datetime", ReadOnly: true, Core: true,
				UIHints: &UIHints{DisplayFormat: "relative-date", Label: "Created"}},
			{Name: "updatedAt", Type: "datetime", ReadOnly: true, Core: true,
				UIHints: &UIHints{DisplayFormat: "relative-date", Label: "Updated"}},
			{Name: "typeVersion", Type: "number", ReadOnly: true, Core: true},
		},
		Layouts: map[string]Layout{
...
func CommunityProfileType() *TypeDefinition {
	return &TypeDefinition{
		...
		Fields: []FieldDef{
			{Name: "userAID", Type: "string", Core: true,
				UIHints: &UIHints{Label: "User AID", Section: "identity"}},
			{Name: "credential", Type: "string", Required: true, ReadOnly: true, Core: true,
				UIHints: &UIHints{Label: "Membership Credential SAID", Section: "membership"}},
			{Name: "role", Type: "string", Required: true, Core: true,
				...
				UIHints:    &UIHints{DisplayFormat: "badge", Label: "Role", Section: "membership", Filterable: true}},
			{Name: "memberSince", Type: "datetime", ReadOnly: true, Core: true,
...
func AdminOnlyProfileType() *TypeDefinition {
	return &TypeDefinition{
		...
		Space:       "admin",
		Fields: []FieldDef{
			{Name: "userAID", Type: "string", Required: true, Core: true,
				UIHints: &UIHints{Label: "User AID", Section: "identity"}},
...
func OrgProfileType() *TypeDefinition {
	return &TypeDefinition{
		...
		Space:       "community-readonly",
		Fields: []FieldDef{
			{Name: "communityName", Type: "string", Required: true, Core: true,
